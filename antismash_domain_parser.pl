...
# place it into the folder with folders of antismash 5,6 or 7 outputs and obtain a parseable table 
...
# VIVA LA PERL!!!
###################################################################################
print "use:  perl AS_domain_parser_folder.pl foldername\n";

@folders=`ls -d ./$ARGV[0]/*\|grep .fna -v`;
foreach(@folders){
	chomp $_;
